...
function gunSound() {
if (geofs.animation.values.brakes == 1) {
...
if (e.distance <= 1000 && (getBearing(e.referencePoint.lla[0], e.referencePoint.lla[1], geofs.aircraft.instance.llaLocation[0], geofs.aircraft.instance.llaLocation[1]) - geofs.animation.values.heading) <= 5 && (getBearing(e.referencePoint.lla[0], e.referencePoint.lla[1], geofs.aircraft.instance.llaLocation[0], geofs.aircraft.instance.llaLocation[1]) - geofs.animation.values.heading) >= -5 && percent(getAltDiff(geofs.aircraft.instance.llaLocation[2], e.referencePoint.lla[2]), e.distance) - Math.abs(geofs.animation.values.atilt) >= -5 && percent(getAltDiff(geofs.aircraft.instance.llaLocation[2], e.referencePoint.lla[2]), e.distance) - Math.abs(geofs.animation.values.atilt) <= 5 && geofs.animation.values.gunsOn == 1) {
